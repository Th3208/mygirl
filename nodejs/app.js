...
app.use(cors({
  "origin": ["http://localhost:8080","http://localhost:8081","http://localhost:5000","http://127.0.0.1:8054"],  //允许所有前端域名
...
app.use('/api/all',require('./routes/api/all'))
app.use('/api/follow',require('./routes/api/follow'))
app.use('/api/girl',require('./routes/api/girl'))
